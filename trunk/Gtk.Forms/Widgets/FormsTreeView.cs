...
{
	[ToolboxItem(true)]
	public class FormsTreeView : TreeView, IBindableComponent//, IListWidget
	{
		private TreeViewDecorator decorator;
		internal TreeViewDecorator Decorator { 
			get {
				if (decorator == null)
					decorator = new TreeViewDecorator (this);
				
				return decorator;
			}
		}
		
		public FormsTreeView ()
			: base ()
		{
		}
		
		public FormsTreeView (IntPtr raw)
			: base (raw)
		{
		}
		
		public FormsTreeView (TreeModel model)
			: base (model)
		{
		}
